...
shinyServer(function(input, output, session) {
  consumer_api_key <- "Kq4mCtnOSPiNwA9ArvYq03DE7" # Enter your consumer key
  consumer_api_secret <- "aWBfVbrJWppmEy3mAbrjUHa6Y8AKU6qkCBZwA6ZpAO8BEFaoC2" # Enter your consumer secret
  access_token <- "529590041-eZXHHkluorWkdRZRWiVYW3GVBuvr3VXt84cZcDYA" # Enter your access token
  access_token_secret <- "rqlG8jzmKTPU3bZoCwgRnOUoD5UYOx8KDjhoXySPrR3mI" # Enter your access secret
